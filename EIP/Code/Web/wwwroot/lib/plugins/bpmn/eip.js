...
function init() {
    ...
    if (!checkLocalStorage()) {
        ...
        currentFile.textContent = "对不起的!没有Web存储支持。如果使用Internet Explorer /微软Edgage，则必须从服务器加载页面以供本地存储工作。";}

    var $ = go.GraphObject.make;  // 更简洁的视觉树定义
    ...
    // 在边界活动事件的定位是基于对boundaryeventarray活动指数
    ...
    var boundaryEventMenu =  // 在活动节点的每个boundaryevent上下文菜单
    ...
    //        eipPalette.requestUpdate();
    //        myPaletteLevel2.requestUpdate();
    //    }
    //});

    eipPalette.model = $(go.GraphLinksModel,
        {
            copiesArrays: true,
            copiesArrayObjects: true,
            nodeDataArray: [
                // -------------------------- Event Nodes
                { key: 101, category: "event", text: "开始", eventType: 1, eventDimension: 1, item: "start" },
                { key: 104, category: "event", text: "结束", eventType: 1, eventDimension: 8, item: "End" },
                //{ key: 102, category: "event", text: "消息", eventType: 2, eventDimension: 2, item: "Message" }, // BpmnTaskMessage
                //{ key: 103, category: "event", text: "定时", eventType: 3, eventDimension: 3, item: "Timer" },
                ...
                //{ key: 133, category: "activity", text: "服务\任务", item: "service task", taskType: 6 },
                // subprocess and start and end
                { key: 134, category: "subprocess", loc: "0 0", text: "子流程", isGroup: true, isSubProcess: true, taskType: 0 },
                { key: -802, category: "event", loc: "0 0", group: 134, text: "开始", eventType: 1, eventDimension: 1, item: "start" },
                ...
                { key: 201, category: "gateway", text: "并行", gatewayType: 1 },
                { key: 204, category: "gateway", text: "串行", gatewayType: 4 },
                //{ key: 301, category: "dataobject", text: "Data\nObject" },
                //{ key: 302, category: "datastore", text: "Data\nStorage" },
                //{ key: 401, category: "privateProcess", text: "区块" },
                { key: "501", "text": "区块", "isGroup": "true", "category": "Pool" },
                ...
                { key: 701, category: "annotation", text: "备注" }
            ]  // end nodeDataArray
        });  // end model
    ...
    loadJSON("/lib/plugins/bpmn/data/OMG BPMN by Example Figure 5.3.json");
} // end init
