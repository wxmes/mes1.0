...
function initNewPasswordEvent() {
    ...
    //初始化控件
    var form = $changePwdForm.form();
    $changePwdForm.formValidation({
        trigger: "blur",
        icon: {
        ...
        UtilAjaxPostWait("/Home/SaveChangePassword", data, function (data) {
...
//初始化数据
function initData() {
    $nameAndCode.val(UtilGetLocalStorage("UserName") + "(" + UtilGetLocalStorage("Code") + ")");
}